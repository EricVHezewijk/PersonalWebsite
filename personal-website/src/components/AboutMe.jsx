    ...
    <div className="about-me-wrapper">
      ...
      <div className="interest-container">
        <div className="interest-text automotive">
          ...
          <p className="interest-description">
            ...
            <br />
            <br />
            I now apply these skills to my programming to create clean, thoughtful software. In fact, I may have never discovered my passion for programming if it weren't for my interest in cars, as that led me into the engineering field in the first place.
          </p>
      ...
      <div className="interest-container">
        ...
        <div className="interest-text nature">
          ...
          <p className="interest-description">
            Growing up on Vancouver Island has given me the opportunity to experience the amazing island's scenery. I'm passionate about a variety of outdoor activities, including camping, hiking, trail running, and swimming in the chilly lakes and oceans that BC is known for. Some of my most recent ventures include summiting the 5040 Peak and hiking the coastal Juan de Fuca Trail!
            <br/>
            <br/>
            While I'm fortunate to live in a such a beautiful province, I also have a strong desire to travel and discover new cultures around the world. Some of my bucket list locations are Switzerland (particularily the Alps), Italy, Southeast Asia and Japan.
          </p>
          <div className="icon-container">
